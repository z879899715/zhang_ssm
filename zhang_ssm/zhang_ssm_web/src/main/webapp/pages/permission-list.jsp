			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="page">
									<li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${page}&pageSize=${pageInfo.pageSize}">${page}</a></li>
								</c:forEach>
								...
								<li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
			...
			$(document)
					.ready(
							function() {
								...
								// 激活导航位置
								setSidebarActive("permission-setting");
